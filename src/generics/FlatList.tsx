...
interface IProps extends ListViewProperties {
 ...
 */
class MetroListView extends React.Component<any, IState> {
  static defaultProps = {
  ...
  state: IState = this._computeState(this.props as any, {
...
export default class FlatList extends React.PureComponent<any> {
  render() {
